...
class _BugSenderPageState extends State<BugSenderPage> {
  ...
  Future<void> _fetchSenders() async {
    ...
    try {
      final response = await http.get(
        Uri.parse("https://evo.nullxteam.fun/mySender?key=${widget.sessionKey}"),
  ...
  Future<void> _addSender(String number, String name) async {
    ...
    try {
      final response = await http.get(
        Uri.parse("https://evo.nullxteam.fun/getPairing?key=${widget.sessionKey}&number=$number"),
      );
    ...
    if (confirmed == true) {
      ...
      try {
        ...
        final response = await http.delete(
          Uri.parse("https://evo.nullxteam.fun/deleteSender?key=${widget.sessionKey}&id=$senderId"),
        );
